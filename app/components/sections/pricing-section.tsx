...
const plans = [
  {
    ...
    features: ["Monthly cleaning service", "Eco-friendly products", "Flexible scheduling", "Professional team"],
  },
  {
    ...
    features: ["Bi-weekly cleanings", "Priority scheduling", "Eco-friendly products", "24/7 support", "Satisfaction guarantee"],
    popular: true,
  },
]
