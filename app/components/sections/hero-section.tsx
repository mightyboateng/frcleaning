  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center">
        <motion.div
          className="absolute w-70 md:w-[320px] aspect-3/4 rounded-xl overflow-hidden shadow-2xl"
        ...
        <motion.div
          className="relative w-70 md:w-[320px] aspect-3/4 rounded-xl overflow-hidden shadow-2xl"
      ...
      >
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif text-center text-foreground mix-blend-difference">
          Spotless, <em className="italic">effortlessly</em>.
        </h1>
      </motion.div>
