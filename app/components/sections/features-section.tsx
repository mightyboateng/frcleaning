      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="mt-4">
              <h3 className="font-serif text-xl text-foreground">Professional Team</h3>
              <p className="text-muted-foreground text-sm mt-1">Trained, certified cleaners dedicated to excellence.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4">
              <h3 className="font-serif text-xl text-foreground">Flexible Scheduling</h3>
              <p className="text-muted-foreground text-sm mt-1">Book weekly, bi-weekly, or monthly cleanings.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-4">
              <h3 className="font-serif text-xl text-foreground">Satisfaction Guaranteed</h3>
              <p className="text-muted-foreground text-sm mt-1">100% satisfaction guarantee or we make it right.</p>
            </div>
          </motion.div>
        </div>
      </div>
